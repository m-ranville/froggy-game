...
@onready var spawn_dummy = main.get_node("spawn_dummy")
@onready var label = main.get_node("Label")
@onready var menu_label = main_menu.get_node("MarginContainer/VBoxContainer/menu_label")
@onready var menu_button = main_menu.get_node("MarginContainer/VBoxContainer/menu_button")
@onready var secondary_button = main_menu.get_node("MarginContainer/VBoxContainer/secondary_button")
